...
module.exports = {
    ...
    run: async (client, interaction, args) => {
      ...
      //.addFields(categories)
        .setDescription(`**${client.user.username} is the Next Generation of Ticket Creations!\nWith <:Powerful:990858389691179028>️ Powerful Systems, Quick Database,\n<:Ticket:990858478128083024> Multiple Ticket Systems, and much more!**`)
